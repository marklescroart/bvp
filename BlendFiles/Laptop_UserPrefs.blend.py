...
kmi = km.keymap_items.new('view3d.viewnumpad', 'ZERO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('view3d.view_orbit', 'TWO', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('view3d.view_orbit', 'FOUR', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'ORBITLEFT')
kmi = km.keymap_items.new('view3d.view_persportho', 'FIVE', 'PRESS', oskey=True)
kmi = km.keymap_items.new('view3d.view_orbit', 'SIX', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'ORBITRIGHT')
kmi = km.keymap_items.new('view3d.viewnumpad', 'SEVEN', 'PRESS', oskey=True)
kmi_props_setattr(kmi.properties, 'type', 'TOP')
kmi = km.keymap_items.new('view3d.view_orbit', 'EIGHT', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'type', 'NEXT_CHARACTER')
kmi = km.keymap_items.new('console.delete', 'K', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'type', 'NEXT_WORD')
...
kmi = km.keymap_items.new('console.clear_line', 'DEL', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('console.indent', 'SPACE', 'PRESS', oskey=True)
