...
- Scene elements -
Object # Add methods for re-doing textures, rendering point cloud, rendering axes, etc.
Shape # OPTIONAL class, defined in Object, for shape-related operations on objects.
Background 
Sky
Camera
Shadow
...
- Actions - 
	...
	- 
- Scenes - 
Scene # will contain links to bvpObjects, bvp_skies, etc..
SceneList
		...
		for o in self.objects:
			if o['nPoses']:
				for p in range(o['nPoses']):
					ObList.append(bvp.Object(o['name'], self, size3D=None, pose=p))
			else:
				ObList.append(bvp.Object(o['name'], self, size3D=None, pose=None))
		return ObList
